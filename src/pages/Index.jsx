...
import { ChakraProvider, Box, Flex, Text, Button, IconButton, Drawer, DrawerBody, DrawerFooter, DrawerHeader, DrawerOverlay, DrawerContent, DrawerCloseButton, Input, Select, useDisclosure, VStack, FormControl, FormLabel, Heading, theme } from "@chakra-ui/react";
...
const validateLogin = () => {
    ...
    // Check if password is empty or too simple
              ...
              <VStack spacing={4} h="80%">
                {activeStep === 1 && (
                  <VStack spacing={4}>
                    ...
                    <FormControl>
                      <Input id="topCanvasText" placeholder="Enter top text" value={topCanvasText} onChange={(e) => setTopCanvasText(e.target.value)} />
                    </FormControl>
                    <FormControl>
                      <Input id="canvasText" value={canvasText} onChange={handleTextChange} />
                    </FormControl>
                    <FormControl>
                      <Input id="bottomCanvasText" placeholder="Enter bottom text" value={bottomCanvasText} onChange={(e) => setBottomCanvasText(e.target.value)} />
                    </FormControl>
